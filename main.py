import fileinput
from tokens import Section, Indent, Commit, Symlink, PRLink, HorizRule, Comment
import sys
...
def main():
    ...
    # Second pass: Print comments before header
    for line in parsed_file:
        for token in line:
            if is_comment(token):
                print_comment(token)
...
This is in a different order than GitHub shows it below, and probably easier
to understand:
"""
...
def is_comment(token):
    return type(token).__name__ == 'Comment'
